...
import CodeBlockNode from '@/components/studio/extensions/CodeBlockNode';
import ImageUpload from '@/components/studio/extensions/ImageUpload';
import ColorHighlighter from '@/components/studio/extensions/ColorHighlighter';
import InlineComment from '@/components/studio/extensions/InlineComment';
import Mention from '@tiptap/extension-mention';
import { PluginKey } from '@tiptap/pm/state';
import MentionPopup from '@/components/studio/MentionPopup';
import MentionTooltip from '@/components/studio/MentionTooltip';
import type { MentionPopupRef } from '@/components/studio/MentionPopup';
import { searchContent } from '@/lib/studio-api';
import type { ContentSearchResult } from '@/lib/studio-api';
import Placeholder from '@tiptap/extension-placeholder';
import CharacterCount from '@tiptap/extension-character-count';
import Link from '@tiptap/extension-link';
import ResizableImage from '@/components/studio/extensions/ResizableImage';
...
import ContainBlock from '@/components/studio/extensions/ContainBlock';
import WikiLink from '@/components/studio/extensions/WikiLink';
import WikiLinkSuggestion from '@/components/studio/extensions/WikiLinkSuggestion';
import type { WikiSuggestionItem } from '@/components/studio/extensions/WikiLinkSuggestion';
import WikiLinkPopup from '@/components/studio/WikiLinkPopup';
import { searchCommonplace } from '@/lib/studio-api';
import { searchObjects } from '@/lib/commonplace-api';
import IframeEmbed from '@/components/studio/extensions/IframeEmbed';
import SlashCommand from '@/components/studio/extensions/SlashCommand';
import type { SlashCommandItem } from '@/components/studio/extensions/SlashCommand';
// Forked: uses notebook's slash commands with Theseus epistemic additions
import { filterSlashCommands } from './extensions/slashCommandItems';
import SlashCommandPopup from '@/components/studio/SlashCommandPopup';
import type { SlashCommandPopupRef } from '@/components/studio/SlashCommandPopup';
...
import DragHandle from '@/components/studio/extensions/DragHandle';
import CustomInputRules from '@/components/studio/extensions/CustomInputRules';
import TabIndent from '@/components/studio/extensions/TabIndent';
import ChartPickerPopup from '@/components/studio/ChartPickerPopup';
