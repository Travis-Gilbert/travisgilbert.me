  ...
  const content = (
    <div
      style={{
        ...
        zIndex: 9000,
        /* EngineTerminal stays dark (intentional terminal aesthetic) */
        ['--cp-term' as string]: '#1A1715',
        ['--cp-term-elevated' as string]: '#1D1917',
        ['--cp-term-hover' as string]: '#221D1A',
        ['--cp-term-border' as string]: 'rgba(255,255,255,0.05)',
        ['--cp-term-border-hover' as string]: 'rgba(201,122,74,0.14)',
        ['--cp-term-text' as string]: '#F1E7DB',
        ['--cp-term-text-secondary' as string]: '#B7AAA0',
        ['--cp-term-muted' as string]: '#8D8178',
        background: 'var(--cp-term, #1A1715)',
        borderTop: '1px solid var(--cp-term-border, rgba(255,255,255,0.05))',
        display: 'flex',
        flexDirection: 'column',
        fontFamily: 'var(--cp-font-mono)',
        fontSize: 12,
        color: 'var(--cp-term-text, #F1E7DB)',
