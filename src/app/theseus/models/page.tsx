    ...
    <div style={{ height: '100%', overflowY: 'auto' }}>
      <div style={{ padding: '40px 40px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
          <svg width="22" height="22" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" style={{ color: '#7B5EA7' }} aria-hidden="true">
        ...
        <p style={{
          ...
          Epistemic models, hypotheses, and structured reasoning.
        </p>
      </div>
